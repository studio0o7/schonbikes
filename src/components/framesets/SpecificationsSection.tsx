...
export default function SpecificationsSection() {
  return (
    <section id="specifications" className="py-12 sm:py-16 md:py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="w-20 sm:w-24 h-1 bg-[#f87f01] mx-auto mb-3 sm:mb-4"></div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 sm:gap-8 mb-6 sm:mb-8">
            ...
            >
              <h3 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 text-gray-800 border-b border-gray-200 pb-2">Frame</h3>
            ...
            <motion.div 
              ...
              className="bg-white rounded-lg shadow-lg p-4 sm:p-6 border border-gray-200"
            >
              <h3 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 text-gray-800 border-b border-gray-200 pb-2">Components</h3>
              <div className="space-y-2 sm:space-y-3">
          ...
          <motion.div 
            ...
            className="bg-white rounded-lg shadow-lg p-4 sm:p-6 border border-gray-200 mb-6 sm:mb-8"
          >
            <h3 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 text-gray-800 border-b border-gray-200 pb-2">Compatibility & Features</h3>
          ...
          >
            ...
            >
              <span 
                className="inline-block px-8 sm:px-16 py-3 sm:py-4 bg-[#f87f01] text-black font-bold text-base sm:text-lg tracking-wider shadow-xl" 
                style={{ 
                  clipPath: "polygon(8% 0%, 100% 0%, 92% 100%, 0% 100%)",
                }}
              >
                <div className="flex items-center justify-center gap-2 sm:gap-3">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 sm:h-6 w-5 sm:w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" />
                  </svg>
                  <span className="text-sm sm:text-base">Premium Quality • ISO4210 Certified</span>
                </div>
              </span>
              {/* Accents */}
...
function SpecRow({ label, value, highlight = false }: SpecRowProps) {
  return (
    <div className="flex justify-between items-start">
      <span className="text-xs sm:text-sm font-medium text-gray-500 w-1/3 flex-shrink-0">{label}</span>
      <span className={`text-xs sm:text-sm text-right ${highlight ? 'text-[#f87f01] font-semibold' : 'text-gray-800'}`}>
        {value}
      </span>
    </div>
  );
...
function FeatureItem({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex items-center">
      <svg xmlns="http://www.w3.org/2000/svg" className="h-3 sm:h-4 w-3 sm:w-4 text-[#f87f01] mr-1 sm:mr-2 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
