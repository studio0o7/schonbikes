...
export default function GeometrySection() {
  ...
  return (
    <section className="bg-white py-10 sm:py-12 md:py-16 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div className="inline-flex items-center justify-center mb-2">
            ...
            <span className="mx-3 text-xs sm:text-sm font-semibold tracking-widest text-[#f87f01] uppercase">Frame measurements</span>
            <div className="h-px w-8 bg-[#f87f01]"></div>
          </div>
          
          <h2 className="text-3xl sm:text-4xl font-bold mb-3 font-racing text-gray-900 relative inline-block">
        ...
        <div className="max-w-7xl mx-auto mb-6">
          <div className="bg-gray-900 rounded-lg shadow-lg border border-gray-800 py-3 sm:py-4 px-3 sm:px-5 flex flex-wrap items-center justify-between gap-3 sm:gap-4 relative overflow-hidden">
            ...
            <div className="flex items-center shrink-0 relative z-10">
              ...
              <h3 className="text-xs sm:text-sm font-semibold text-white mr-3">Select Size:</h3>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-2 sm:gap-3 relative z-10">
              {['490', '520', '550', '580'].map((size) => (
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className={`py-1.5 sm:py-2 px-3 sm:px-4 rounded-lg transition-all duration-300 relative border text-sm ${
                    selectedSize === size 
                ...
                >
                  <span className="font-racing">{size}</span>
                  {selectedSize === size && (
                    <motion.div 
                      initial={{ scale: 0 }}
                      animate={{ scale: 1 }}
            ...
            <div className="w-full sm:w-auto text-xs sm:text-sm text-gray-300 flex items-center shrink-0 relative z-10 mt-2 sm:mt-0">
              <span className="text-gray-400 mr-1">Recommended for:</span>
        ...
        <div className="flex flex-col lg:flex-row gap-6 sm:gap-8 max-w-7xl mx-auto">
          ...
          >
            <div className="bg-white p-4 sm:p-5 rounded-xl shadow-lg border border-gray-200 relative flex-grow">
              {/* Size indicator */}
              <div className="absolute -top-3 sm:-top-4 left-1/2 transform -translate-x-1/2 bg-[#f87f01] text-white font-bold py-1 px-4 sm:px-6 rounded-full shadow-md z-20 text-sm sm:text-base">
                <span className="font-racing">Size {selectedSize}</span>
              </div>
              
              {/* Frame diagram - reduced vertical padding */}
              <div className="bg-gradient-to-br from-gray-50 to-white rounded-lg shadow-inner flex items-center justify-center overflow-hidden p-2 sm:p-3 border border-gray-100 relative mt-2">
                <div className="relative w-full flex items-center justify-center">
                  ...
                  {/* Corner accent */}
                  <div className="absolute top-0 right-0 border-t-[30px] sm:border-t-[40px] border-r-[30px] sm:border-r-[40px] border-t-transparent border-r-[#f87f01] z-20"></div>
                  <div className="absolute bottom-0 left-0 border-b-[20px] sm:border-b-[30px] border-l-[20px] sm:border-l-[30px] border-b-transparent border-l-[#f87f01]/50 z-20"></div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2 sm:gap-3 mt-3 sm:mt-4">
                {[
                  ...
                  <div key={index} className="bg-gradient-to-br from-gray-50 to-white p-2 rounded-lg border border-gray-200 shadow-sm">
                    ...
                    <p className="text-base sm:text-lg font-racing text-[#f87f01] font-semibold">{item.value}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="mt-3 sm:mt-4 bg-gray-50 rounded-lg p-2 sm:p-3 border-l-2 border-[#f87f01] flex items-start shadow-sm">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 sm:h-5 w-4 sm:w-5 text-[#f87f01] mr-2 mt-0.5 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
          ...
          >
            <div className="bg-white p-4 sm:p-5 rounded-xl shadow-lg border border-gray-200 h-full">
                ...
                <table className="min-w-full border-collapse">
                  <thead>
                    <tr className="bg-gradient-to-r from-gray-50 to-white">
                      <th colSpan={4} className="py-2 sm:py-3 px-2 sm:px-4 text-center border-b-2 border-[#f87f01] font-bold text-gray-800 text-sm sm:text-base">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    <tr className="hover:bg-gray-50 transition-colors">
                      <td className="py-2 sm:py-3 px-2 sm:px-4 font-medium text-gray-800 text-xs sm:text-sm">SEAT TUBE LENGTH</td>
                      <td className="py-2 sm:py-3 px-2 sm:px-4 text-[#f87f01] font-semibold text-xs sm:text-sm">
                        {selectedSize === '490' ? '490mm' : 
                         selectedSize === '520' ? '520mm' : 
                         selectedSize === '550' ? '550mm' : '580mm'}
                      </td>
                      <td className="py-2 sm:py-3 px-2 sm:px-4 font-medium text-gray-800 text-xs sm:text-sm">HEAD TUBE LENGTH</td>
                      <td className="py-2 sm:py-3 px-2 sm:px-4 text-[#f87f01] font-semibold text-xs sm:text-sm">
                    ...
                    <tr className="hover:bg-gray-50 transition-colors bg-gray-50">
                      <td className="py-2 sm:py-3 px-2 sm:px-4 font-medium text-gray-800 text-xs sm:text-sm">TOP TUBE LENGTH</td>
                      <td className="py-2 sm:py-3 px-2 sm:px-4 text-[#f87f01] font-semibold text-xs sm:text-sm">
                        {selectedSize === '490' ? '535mm' : 
                         selectedSize === '520' ? '550mm' : 
                         selectedSize === '550' ? '575mm' : '595mm'}
                      </td>
                      <td className="py-2 sm:py-3 px-2 sm:px-4 font-medium text-gray-800 text-xs sm:text-sm">STACK</td>
                      <td className="py-2 sm:py-3 px-2 sm:px-4 text-[#f87f01] font-semibold text-xs sm:text-sm">
                    ...
                    <tr className="hover:bg-gray-50 transition-colors">
                      <td className="py-2 sm:py-3 px-2 sm:px-4 font-medium text-gray-800 text-xs sm:text-sm">REACH</td>
                      <td className="py-2 sm:py-3 px-2 sm:px-4 text-[#f87f01] font-semibold text-xs sm:text-sm">
                        {selectedSize === '490' ? '374.1mm' : 
                         selectedSize === '520' ? '377.5mm' : 
                         selectedSize === '550' ? '386mm' : '397.1mm'}
                      </td>
                      <td className="py-2 sm:py-3 px-2 sm:px-4 font-medium text-gray-800 text-xs sm:text-sm">WHEELBASE</td>
                      <td className="py-2 sm:py-3 px-2 sm:px-4 text-[#f87f01] font-semibold text-xs sm:text-sm">
                    ...
                    <tr className="hover:bg-gray-50 transition-colors bg-gray-50">
                      <td className="py-2 sm:py-3 px-2 sm:px-4 font-medium text-gray-800 text-xs sm:text-sm">CHAINSTAY LENGTH</td>
                      <td className="py-2 sm:py-3 px-2 sm:px-4 text-[#f87f01] font-semibold text-xs sm:text-sm">430mm</td>
                      <td className="py-2 sm:py-3 px-2 sm:px-4 font-medium text-gray-800 text-xs sm:text-sm">FRONT CENTER</td>
                      <td className="py-2 sm:py-3 px-2 sm:px-4 text-[#f87f01] font-semibold text-xs sm:text-sm">
                    ...
                    <tr className="hover:bg-gray-50 transition-colors">
                      <td className="py-2 sm:py-3 px-2 sm:px-4 font-medium text-gray-800 text-xs sm:text-sm">BB DROP</td>
                      <td className="py-2 sm:py-3 px-2 sm:px-4 text-[#f87f01] font-semibold text-xs sm:text-sm">70mm</td>
                      <td className="py-2 sm:py-3 px-2 sm:px-4 font-medium text-gray-800 text-xs sm:text-sm">BB HEIGHT</td>
                      <td className="py-2 sm:py-3 px-2 sm:px-4 text-[#f87f01] font-semibold text-xs sm:text-sm">285mm</td>
                    </tr>
                    <tr className="hover:bg-gray-50 transition-colors bg-gray-50">
                      <td className="py-2 sm:py-3 px-2 sm:px-4 font-medium text-gray-800 text-xs sm:text-sm">SEAT TUBE ANGLE</td>
                      <td className="py-2 sm:py-3 px-2 sm:px-4 text-[#f87f01] font-semibold text-xs sm:text-sm">
                        {selectedSize === '490' ? '73.5°' : 
                         selectedSize === '520' ? '73°' : 
                         selectedSize === '550' ? '72.5°' : '72.5°'}
                      </td>
                      <td className="py-2 sm:py-3 px-2 sm:px-4 font-medium text-gray-800 text-xs sm:text-sm">HEAD TUBE ANGLE</td>
                      <td className="py-2 sm:py-3 px-2 sm:px-4 text-[#f87f01] font-semibold text-xs sm:text-sm">
                        {selectedSize === '490' ? '71°' : 
                    ...
                    <tr className="hover:bg-gray-50 transition-colors">
                      <td className="py-2 sm:py-3 px-2 sm:px-4 font-medium text-gray-800 text-xs sm:text-sm">FORK RAKE/OFFSET</td>
                      <td className="py-2 sm:py-3 px-2 sm:px-4 text-[#f87f01] font-semibold text-xs sm:text-sm">50mm</td>
                      <td className="py-2 sm:py-3 px-2 sm:px-4 font-medium text-gray-800 text-xs sm:text-sm">FORK LENGTH</td>
                      <td className="py-2 sm:py-3 px-2 sm:px-4 text-[#f87f01] font-semibold text-xs sm:text-sm">397mm</td>
                    </tr>
                    <tr className="hover:bg-gray-50 transition-colors bg-gray-50">
                      <td className="py-2 sm:py-3 px-2 sm:px-4 font-medium text-gray-800 text-xs sm:text-sm">TRAIL</td>
                      <td className="py-2 sm:py-3 px-2 sm:px-4 text-[#f87f01] font-semibold text-xs sm:text-sm">
                        {selectedSize === '490' ? '69.3mm' : 
                         selectedSize === '520' ? '66.1mm' : 
                         selectedSize === '550' ? '62.7mm' : '62.7mm'}
                      </td>
                      <td className="py-2 sm:py-3 px-2 sm:px-4 font-medium text-gray-800 text-xs sm:text-sm">SEATPOST INSERT LENGTH</td>
                      <td className="py-2 sm:py-3 px-2 sm:px-4 text-[#f87f01] font-semibold text-xs sm:text-sm">
                    ...
                    <tr className="hover:bg-gray-50 transition-colors">
                      <td className="py-2 sm:py-3 px-2 sm:px-4 font-medium text-gray-800 text-xs sm:text-sm">STANDOVER HEIGHT (700C)</td>
                      <td className="py-2 sm:py-3 px-2 sm:px-4 text-[#f87f01] font-semibold text-xs sm:text-sm">
                        {selectedSize === '490' ? '776.4mm' : 
                         selectedSize === '520' ? '793.4mm' : 
                         selectedSize === '550' ? '833.4mm' : '863.9mm'}
                      </td>
                      <td className="py-2 sm:py-3 px-2 sm:px-4 font-medium text-gray-800 text-xs sm:text-sm">STANDOVER HEIGHT (650B)</td>
                      <td className="py-2 sm:py-3 px-2 sm:px-4 text-[#f87f01] font-semibold text-xs sm:text-sm">
