...
export default function DesignDetailsSection() {
  return (
    <section id="design-details" className="py-24 bg-black text-white">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <motion.div
            ...
            className="mb-20 bg-gradient-to-b from-gray-900 to-black rounded-xl overflow-hidden shadow-2xl border border-gray-800"
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
              ...
              <div className="p-8 lg:p-10 flex flex-col justify-center">
                <div className="inline-flex items-center mb-4">
                  ...
                  <span className="mx-3 text-sm font-semibold tracking-widest text-[#f87f01] uppercase">Premium Experience</span>
                </div>
                
                <h3 className="text-3xl font-bold mb-6 text-white">Engineered for Excellence</h3>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="bg-black/40 backdrop-blur-sm p-4 rounded-lg border-l-2 border-[#f87f01]">
                    ...
                    <p className="text-gray-400 text-sm">Di2 and electronic groupset compatible with hidden battery integration</p>
                  </div>
                  ...
                  <div className="bg-black/40 backdrop-blur-sm p-4 rounded-lg border-l-2 border-[#f87f01]">
                    ...
                    <p className="text-gray-400 text-sm">Meets ISO4210 standards for performance, durability and safety</p>
                  </div>
                </div>
                
                <div className="flex flex-wrap gap-4 mt-2">
                  <span className="bg-[#f87f01]/20 text-[#f87f01] text-xs font-medium px-3 py-1 rounded-full">Integrated Cables</span>
                  <span className="bg-[#f87f01]/20 text-[#f87f01] text-xs font-medium px-3 py-1 rounded-full">Premium Carbon</span>
                  <span className="bg-[#f87f01]/20 text-[#f87f01] text-xs font-medium px-3 py-1 rounded-full">Aero Design</span>
                  <span className="bg-[#f87f01]/20 text-[#f87f01] text-xs font-medium px-3 py-1 rounded-full">Custom Geometry</span>
                </div>
              </div>
              
              {/* Right side - Image */}
              <div className="relative overflow-hidden h-full min-h-[300px] lg:min-h-0">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold mb-3 text-white">Integrated Seatpost</h3>
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold mb-3 text-white">Integrated Storage</h3>
                <p className="text-gray-300 mb-4">
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold mb-3 text-white">Integrated Cockpit</h3>
                <p className="text-gray-300 mb-4">
          ...
          <motion.div
            ...
            className="bg-gradient-to-r from-gray-900 to-black rounded-xl p-8 border-l-2 border-[#f87f01] shadow-xl"
          >
            <h3 className="text-2xl font-semibold mb-4 text-white">German Engineering Excellence</h3>
            ...
            <div className="flex flex-wrap gap-6 mt-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-300">UCI Approved</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 bg-[#f87f01] rounded-full"></div>
                <span className="text-gray-300">Wind Tunnel Tested</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 bg-[#f87f01] rounded-full"></div>
                <span className="text-gray-300">Impact Tested</span>
              </div>
            </div>
          </motion.div>
        </div>
...
function FeatureItem({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex items-center gap-2">
      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-[#f87f01] flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
