...
const RAD35Section = () => {
  ...
  return (
    <section id="rad35-section" className="py-24 bg-white overflow-hidden relative">
      {/* Decorative elements */}
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            <div className="relative">
              ...
              {/* Badge */}
              <div className="absolute -bottom-5 right-10 bg-white text-gray-800 px-6 py-3 rounded-full shadow-lg border-2 border-[#f87f01]/80">
                <span className="text-xl font-bold">35mm Depth</span>
              </div>
            </div>
            
            {/* Specs badge */}
            <div className="absolute -left-10 top-1/2 -translate-y-1/2 bg-white/90 backdrop-blur-sm p-4 rounded-lg border-l-2 border-[#f87f01] shadow-lg">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
              <div className="bg-gray-100 p-4 rounded-lg border-l-2 border-[#f87f01]">
              ...
              <div className="bg-gray-100 p-4 rounded-lg border-l-2 border-[#f87f01]">
                <h3 className="text-lg font-semibold mb-2">Pillar 1423 Spokes</h3>
                <p className="text-sm text-gray-600">
