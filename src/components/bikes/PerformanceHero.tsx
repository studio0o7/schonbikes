    ...
    <section className="relative min-h-screen bg-black overflow-hidden">
      ...
      <div className="container mx-auto h-full relative z-20 px-4">
        <div className="flex flex-col lg:flex-row h-full py-12 lg:py-0">
          ...
          <div className="lg:w-1/2 relative flex items-center justify-center p-4 sm:p-8 order-2 lg:order-1 mt-8 lg:mt-0">
            <motion.div 
            ...
            >
              {/* Design elements */}
              <div className="absolute -top-4 -left-4 w-12 sm:w-16 h-12 sm:h-16 border-2 border-[#f87f01] z-20"></div>
              <div className="absolute -bottom-4 -right-4 w-12 sm:w-16 h-12 sm:h-16 border-2 border-[#f87f01] z-20"></div>
            ...
            {/* Side badge - hidden on very small screens */}
          ...
          <div className="lg:w-1/2 flex items-center justify-center order-1 lg:order-2">
            <div className="text-white px-4 sm:px-8 py-8 sm:py-12 max-w-lg">
              ...
              <motion.h1 
                ...
                className="text-4xl sm:text-5xl lg:text-7xl font-bold mb-4 leading-tight font-racing"
              >
                One
              ...
              >
                <p className="text-xl sm:text-2xl mb-4 sm:mb-6 text-gray-300 font-light">Bike for Performance - Road</p>
              ...
              >
                ...
                >
                  <button 
                    ...
                    className="cursor-pointer w-full"
                  >
                    <div className="rhombus-btn-outline relative overflow-hidden group w-full">
