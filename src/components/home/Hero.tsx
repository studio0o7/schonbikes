    ...
    <section className="relative h-screen bg-black overflow-hidden">
      ...
      <div className="container mx-auto h-full relative z-20">
        <div className="flex flex-col lg:flex-row h-full">
          {/* Content side (takes up left half on lg screens) */}
          <div className="lg:w-1/2 flex items-center justify-center">
            <div className="text-white px-8 py-12 max-w-lg">
              ...
              >
                <p className="text-2xl mb-6 text-gray-300 font-light">Deserves a custom experience</p>
              ...
              >
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-300">Performance Engineered</span>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-[#f87f01] rounded-full"></div>
                  <span className="text-sm text-gray-300">Custom Fitted</span>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-[#f87f01] rounded-full"></div>
                  <span className="text-sm text-gray-300">Premium Materials</span>
                </div>
              </motion.div>
      ...
      {/* Side badge */}
      <div className="absolute top-1/2 left-3 -translate-y-1/2 rotate-90 origin-left z-30">
