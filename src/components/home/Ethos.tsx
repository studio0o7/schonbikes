  ...
  return (
    <section className="py-16 md:py-24 bg-black text-white relative overflow-hidden">
      ...
      <div className="container mx-auto relative z-10 px-4">
        ...
        >
          <span className="inline-block text-xs sm:text-sm font-semibold tracking-[0.25em] text-[#f87f01] uppercase mb-3 px-4 sm:px-6 py-2 border border-[#f87f01]/30 rounded-full">German Precision, Global Reach</span>
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6 font-racing">
            The <span className="text-[#f87f01] relative inline-block">
              Art & Science
              <svg className="absolute -bottom-4 sm:-bottom-6 left-0 w-full" viewBox="0 0 100 15" preserveAspectRatio="none">
                <path d="M0,5 Q50,15 100,5" stroke="#f87f01" strokeWidth="2" fill="none" />
              </svg>
            </span> of Perfect Fit
          </h2>
          <div className="w-16 md:w-24 h-1 bg-[#f87f01] mx-auto mb-6 md:mb-8"></div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-16 md:mb-24">
          ...
          >
            ...
            <div className="p-6 md:p-8 rounded-xl bg-gray-900 border border-gray-800 group-hover:border-[#f87f01]/50 transition-all duration-300 h-full">
              <div className="w-12 h-12 md:w-16 md:h-16 mb-4 md:mb-6 relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 md:h-10 md:w-10 text-[#f87f01]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                  </svg>
                </div>
              </div>
              <h3 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-white group-hover:text-white transition-colors duration-300">Your Measurements</h3>
          ...
          >
            ...
            <div className="p-6 md:p-8 rounded-xl bg-gray-900 border border-gray-800 group-hover:border-[#f87f01]/50 transition-all duration-300 h-full">
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-white group-hover:text-white transition-colors duration-300">German Engineering</h3>
              <p className="text-sm md:text-base text-gray-300 group-hover:text-white transition-colors duration-300">
          ...
          >
            ...
            <div className="p-6 md:p-8 rounded-xl bg-gray-900 border border-gray-800 group-hover:border-[#f87f01]/50 transition-all duration-300 h-full">
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-white group-hover:text-white transition-colors duration-300">Global Delivery</h3>
              <p className="text-sm md:text-base text-gray-300 group-hover:text-white transition-colors duration-300">
        ...
        <div className="flex flex-col lg:flex-row items-stretch gap-10 lg:gap-16">
          ...
          >
            <div className="relative mb-6">
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold font-racing text-white relative z-10 leading-tight">
                German Precision,<br /><span className="text-[#f87f01]">Global Excellence</span>
              </h3>
              <div className="absolute -left-4 sm:-left-6 top-0 h-full w-2 bg-[#f87f01]"></div>
            </div>
            <p className="mb-4 md:mb-5 text-sm md:text-base text-gray-300 leading-relaxed">
            ...
            <p className="mb-6 md:mb-8 text-sm md:text-base text-gray-300 leading-relaxed">
            ...
            <div className="grid grid-cols-2 gap-3 md:gap-4 mb-6 md:mb-8">
              <div className="bg-gray-900/70 p-3 md:p-5 rounded-lg border border-gray-800 text-center transform transition-transform hover:scale-105 hover:border-[#f87f01]/50">
                <div className="text-2xl md:text-3xl font-bold text-[#f87f01]">Global</div>
                <p className="text-xs md:text-sm text-gray-400 mt-1">International Markets Served</p>
              </div>
              <div className="bg-gray-900/70 p-3 md:p-5 rounded-lg border border-gray-800 text-center transform transition-transform hover:scale-105 hover:border-[#f87f01]/50">
                <div className="text-2xl md:text-3xl font-bold text-[#f87f01]">100%</div>
                <p className="text-xs md:text-sm text-gray-400 mt-1">Custom Built</p>
              </div>
            </div>
            
            <div className="flex items-center gap-2 text-gray-400 italic text-sm md:text-base">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 md:h-5 md:w-5 text-[#f87f01]" viewBox="0 0 20 20" fill="currentColor">
          ...
          >
            <div className="relative overflow-hidden aspect-[4/3]">
              ...
              <div className="absolute bottom-0 left-0 p-4 md:p-6 z-20">
                <div className="text-xs text-[#f87f01] font-semibold tracking-wider mb-1 md:mb-2 uppercase">Premium Performance</div>
                <div className="text-lg md:text-xl font-bold">SchönMO Custom Design</div>
              </div>
            ...
            <div className="absolute -bottom-6 md:-bottom-12 -left-6 md:-left-12 w-16 md:w-24 h-16 md:h-24 border-2 border-[#f87f01] -z-10 transform rotate-10"></div>
            <div className="absolute -top-6 md:-top-8 -right-6 md:-right-8 w-16 md:w-24 h-16 md:h-24 border-2 border-[#f87f01] -z-10"></div>
            
            <div className="absolute top-1/2 -right-4 transform -translate-y-1/2 rotate-90 hidden md:block">
